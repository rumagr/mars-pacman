...
public class ComplexAgent : IAgent<MazeLayer>, IPositionable
{
    #region Init
    ...
    private void ExploreAgents()
    {
        ...
        var agents = _layer.GhostAgentEnvironment.Explore(Position, radius: AgentExploreRadius);
